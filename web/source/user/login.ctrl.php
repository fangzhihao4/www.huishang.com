...
function _login($forward = '') {
	...
	if (!empty($record)) {
		...
		//$forward = ".index.php?c=wxapp&a=display&do=switch&module=zjhj_mall&version_id=1&uniacid=2";
		$forward = "./index.php?c=account&a=display&do=switch&module=zjhj_mall&version_id=1&uniacid=2";

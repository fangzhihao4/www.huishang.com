...
Page({
    ...
    reLoad: function() {
        var d = this, t = wx.getStorageSync("users").id;
        app.util.request({
            ...
            success: function(t) {
                ...
                app.util.request({
                    ...
                    success: function(t) {
                        ...
                        for (var r = 0; r < c.length; r++) for (var i = 0; i < e.length; i++) c[r].date.toString() == e[i].day && (c[r].tsrq = e[i]);
                        d.setData({
                            days: c
                        });
                    }
    ...
    bq: function() {
        ...
        if (0 == t.length) var l = e.data.qdset[0].one; else l = 0;

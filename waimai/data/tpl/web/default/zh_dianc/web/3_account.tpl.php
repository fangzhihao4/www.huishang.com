...
<div class="main">
    <div class="panel panel-default ygbody">
        <div class="panel-body">
            <p class="yangshi">商户后台登陆地址:&nbsp;&nbsp;<a href="<?php  echo $_W['siteroot'];?>web/zhstore.php?c=user&a=login" target="_blank"><?php  echo $_W['siteroot'];?>web/zhstore.php?c=user&a=login</a></p>
        </div>
    </div>

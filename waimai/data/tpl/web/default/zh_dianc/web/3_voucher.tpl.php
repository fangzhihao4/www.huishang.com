        ...
        <div class="panel-body" style="padding: 0px 15px;">
            <div class="row">
                <table class="yg5_tabel col-md-12">
                    <tr class="yg5_tr1">
                        <th class="store_td1 col-md-1">代金券名称</th>
                    ...
                    <tr class="yg5_tr2">
                        ...
                        <td><div class="type-parent"><?php  echo $item['preferential'];?></div></td>
                        <td><div class="type-parent"><?php  echo $item['start_time'];?></div></td>
                        <td><?php  echo $item['end_time'];?></td>
                        <td><?php  echo $item['instruction'];?></td>
                        <?php  if($item['voucher_type']==1) { ?>
                  <td>
                  <span class="label storeblue"> 仅限外卖使用</span>
                 
                  </td>
                   <?php  } else if($item['voucher_type']==2) { ?>
                    <td>
                    <span class="label storeblue"> 仅限店内使用</span>              
                  </td>
                  <?php  } else if($item['voucher_type']==3) { ?>
                    <td>
                    <span class="label storered">两者都可使用</span> 
                  </td>
                   <?php  } ?>
                        <td>
                            <a href="<?php  echo $this->createWebUrl('addvoucher', array('id' => $item['id']))?>" class="storespan btn btn-xs">

...
<style type="text/css">
    ...
    .input_box{border-radius: 4px;padding: 5px;margin-right: 10px;color: white;}
...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="<?php  echo $this->createWebUrl2('dldishes2')?>">商品管理</a></li>
    <li><a href="<?php  echo $this->createWebUrl2('dladddishes')?>">添加商品</a></li>
</ul> 
   	...
   	<!-- <div class="main">
        ...
        <form action="" method="get" class="col-md-12" style="padding: 0px;">
        	<div class="col-md-12 ygboxl">
               ...
               <input type="hidden" name="do" value="dldishes2" />
	            <div class="col-md-2" style="padding: 0px;">
	                <div class="yg_name">商品名称</div>
	                <input type="text" name="keywords" class="form-control yg_left" placeholder="请输入商品名称"> 
	            </div>
	            <div class="col-md-3">
                    <div class="yg_name">
                        商品类型
	            ...
	            <div class="col-md-3">
                    ...
                    <select style="width: 200px;color: #333;" name="is_shelves2">
                      	<option value="">不限</option>
	            ...
	            <div class="col-md-3">
                    ...
                    <select style="width: 200px;color: #333;" name="type_id">
                    <option value="">不限</option>
	            ...
	            <div class="col-md-1">
		            <input type="submit" value="搜索" name="submit" class="btn storeblue btn-sm"/>
...
<div class="dishes">
	...
	<button class="btn storegrey2 dish_left" id="alldown">批量下架</button>
  	...
  	<form method="post" action="" enctype="multipart/form-data" class="dishes">
        ...
        <div class="input_box"><input  type="file" name="file_stu" class="btn storeblue" /></div>
        <input type="hidden" name="token" value="<?php  echo $_W['token'];?>"/>
        <input type="submit" name="submit2"  value="导入" class="dishes_inp2 btn storeblue btn-sm" />
    </form>
        <a class="btn btn-sm storeblue ms_mb" href="<?php  echo $_W['siteroot'];?>/addons/zh_dianc/inc/upload/dishes.xls">下载导入模板</a>
            ...
            <div class="row">
                <table class="yg5_tabel col-md-12">
                    ...
                    <tr class="yg5_tr2">
                      ...
                      <td> <span class="label storered">店内商品</span></td>
                      <?php  } else if($item['dishes_type']==1) { ?>
                      <td> <span class="label storeblue">外卖商品</span></td>
                      <?php  } else if($item['dishes_type']==3) { ?>
                      <td>  <span class="label btn-warning">店内+外卖</span></td>
                      <?php  } ?>
                        ...
                        <td class="col-md-1 xs_num<?php  echo $item['id'];?>"> 
                         ...
                         <td class="col-md-1 dish_btn">
                            ...
                            <td class="col-md-2 dish_btn">
                            	<a href="<?php  echo $this->createWebUrl2('dladddishes', array('id' => $item['id']))?>" class="storespan btn btn-xs">
                                    <span class="fa fa-pencil"></span>
                                    <span class="bianji">编辑
                                        <span class="arrowdown"></span>
                                    </span>                                
                                </a>
                                <a href="<?php  echo $this->createWebUrl2('dlspec',array('dishes_id' => $item['id']));?>" class="storespan btn btn-xs">
                            	...
                            	<!-- <a class="btn btn-success btn-xs" href="<?php  echo $this->createWebUrl2('dladddishes', array('id' => $item['id']))?>" title="编辑">编辑</a>
                            	&nbsp;&nbsp;
                            	<a class="btn btn-success btn-xs" href="<?php  echo $this->createWebUrl2('dlspec',array('dishes_id' => $item['id']));?>" title="添加规格">添加规格</a>
                            	&nbsp;&nbsp;
                    ...
                    <div class="modal fade" id="myModal<?php  echo $item['id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                      <div class="modal-dialog" role="document">
                        ...
                        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                            <a href="<?php  echo $this->createWebUrl2('dldishes2', array('op' => 'delete', 'delid' => $item['id']))?>" type="button" class="btn btn-info" >确定</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="modal fade" id="myModalb<?php  echo $item['id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                      <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                            <a href="<?php  echo $this->createWebUrl2('dldishes2',array('id'=>$item['id'],'is_shelves'=>1,'page'=>$_GPC['page'],'keywords'=>$_GPC['keywords'],'dishes_type'=>$_GPC['dishes_type'],'type_id'=>$_GPC['type_id'],'is_shelves2'=>$_GPC['is_shelves2']));?>" type="button" class="btn btn-info" >确定</a>
                        </div>
                    </div>
                </div>
            </div>
             ...
             <div class="modal fade" id="myModalc<?php  echo $item['id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                      <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                            <a href="<?php  echo $this->createWebUrl2('dldishes2',array('id'=>$item['id'],'is_shelves'=>2,'page'=>$_GPC['page'],'keywords'=>$_GPC['keywords'],'dishes_type'=>$_GPC['dishes_type'],'type_id'=>$_GPC['type_id'],'is_shelves2'=>$_GPC['is_shelves2']));?>" type="button" class="btn btn-info" >确定</a>
                        </div>
                    </div>
                </div>
            </div>

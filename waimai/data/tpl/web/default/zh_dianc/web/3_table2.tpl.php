...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="<?php  echo $this->createWebUrl('table2')?>">餐桌列表</a></li>
...
<!--                   <a class="btn btn-success btn-sm tabel_btn" href="javascript:void(0);">
                  ...
                  <a class="btn storered btn-sm tabel_btn" href="<?php  echo $this->createWebUrl('table2',array('op'=>'qt'))?>">
                    一键清台
                  </a>
<!--                   <a class="btn btn-primary btn-sm tabel_btn" href="javascript:void(0);">
                ...
                <div class="yg5_tabel col-md-12">
                        ...
                        <div class="col-md-2 yg5_td">
                            <div class="tabel_cha">
                                <a onclick="if(!confirm('删除后将不可恢复,确定删除吗?')) return false;" href="<?php  echo $this->createWebUrl('table2',array('id'=>$row['id'],'op'=>'del'))?>"><span class="">×</span>

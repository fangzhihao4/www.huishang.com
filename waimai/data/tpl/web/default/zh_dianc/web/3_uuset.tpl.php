    ...
    <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data">
        ...
        <div class="panel panel-default ygdefault">
            ...
            <!--      <div class="form-group">
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">绑定账号</label>
                    <div class="col-sm-9">
                        <input type="text" name="account" class="form-control" value="<?php  echo $info['account'];?>" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="OpenId" class="form-control" value="<?php  echo $info['OpenId'];?>" />
                    </div>
                </div>

...
<div class="panel panel-default yg14">
    ...
    <div class="panel-heading wyheader">积分规则</div>
                                ...
                                <script type="text/javascript">
                                   $(function(){
                                      $(".shanchu<?php  echo $row['id'];?>").click(function(){          
                                          ...
                                          $.ajax({
                                              type:"post",
                                              url:"<?php  echo $_W['siteroot'];?>/app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&do=DelQd&m=zh_dianc",
                                              dataType:"text",
                                              data:{id:id},
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $("input[name='button']").click(function(){
          ...
          $.ajax({
              type:"post",
              url:"<?php  echo $_W['siteroot'];?>/app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&do=AddQd&m=zh_dianc",
              dataType:"text",
              data:{
                list:list,
                color:color,

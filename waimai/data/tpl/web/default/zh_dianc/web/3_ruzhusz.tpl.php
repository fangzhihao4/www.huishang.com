        ...
        <div class="panel panel-default ygdefault">
            ...
            <div class="panel-body">
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">是否开启入驻功能</label>
                    <div class="col-sm-9">
                        <label class="radio-inline">
                            <input type="radio" id="emailwy1" name="is_ruzhu" value="1" <?php  if($item['is_ruzhu']==1 || empty($item['is_ruzhu'])) { ?>checked<?php  } ?> />
                            <label for="emailwy1">开启</label>
                        </label>
                        <label class="radio-inline">
                            <input type="radio" id="emailwy2" name="is_ruzhu" value="2" <?php  if($item['is_ruzhu']==2) { ?>checked<?php  } ?> />
                            <label for="emailwy2">关闭</label>
                        </label>
                        <div class="ygmargin">(*关闭后小程序端不显示入驻入口)</div>    
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">是否开启食品许可证和身份证上传</label>
                    <div class="col-sm-9">
                        <label class="radio-inline">

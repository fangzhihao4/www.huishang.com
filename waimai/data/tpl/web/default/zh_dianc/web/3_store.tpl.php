                ...
                <div class="row">                    
                    <form action="" method="get">
                        ...
                        <div class="col-md-3 yg5_key">
                            ...
                            <option value="">不限</option>
                             <?php  if(is_array($area)) { foreach($area as $row2) { ?>                                
                                 <option value="<?php  echo $row2['id'];?>"><?php  echo $row2['area_name'];?></option>
                            <?php  } } ?>
                            </select>
                        </div>
                ...
                <div class="row">
                    <table class="yg5_tabel col-xs-12">
                        ...
                        <tr class="yg5_tr2">
                            ...
                            <td>
                                <img class="store_list_img" src="<?php  echo tomedia($row['md_logo']);?>" alt=""/>
                              <!--   <span></span> -->
                            </td>
                            ...
                            <td class="td_type">
                                ...
                                <?php  } ?>
                                <?php  if($row['is_dn']==1) { ?>
                                <span class="btn btn-xs storesuccess">店内</span>
                                <?php  } ?>
                                <?php  if($row['is_sy']==1) { ?>
                                <span class="btn btn-xs ygshouqian">收银</span>
                                <?php  } ?>
                                <?php  if($row['is_pd']==1) { ?>
                                <span class="btn btn-xs ygyouhui">优惠券</span>
                                <?php  } ?>
                            </td>
                            <td><?php  echo $row['md_content'];?></td>
                            <?php  if($_W['role']!='operator') { ?>
                            <td class="ygcopy1"><?php  if($row['is_open']==1) { ?>
                                <a href="javascript:void(0);" data-toggle="modal" data-target="#myModal3<?php  echo $row['id'];?>">
                                    <span class="yglabel">开启</span>
                                </a>
                            <?php  } else if($row['is_open']==2) { ?>                          
                                 <a href="javascript:void(0);" data-toggle="modal" data-target="#myModalfour<?php  echo $row['id'];?>">
                            ...
                            <a href="javascript:void(0);" class="storespan btn btn-xs" data-toggle="modal" data-target="#myModal2<?php  echo $row['id'];?>">
                        ...
                        <!-- —————————————关闭的弹框————————————— -->
                        <div class="modal fade" id="myModalfour<?php  echo $row['id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>

    ...
    <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data">
        ...
        <div class="panel panel-default ygdefault">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" name="xyh_open">
                            <?php  if($info['xyh_open']==1) { ?>
                            <option value="1" selected="selected">是</option>
                            <option value="2">否</option>
                            <?php  } else if($info['xyh_open']==2) { ?>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="number" name="xyh_money" value="<?php  echo $info['xyh_money'];?>" class="form-control" id="inputEmail3"
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label" style="margin-right: 15px;">幻灯片是否显示</label>
                    <select class="col-sm-8" name="is_display">
                        <?php  if($info['is_display']==1) { ?>
                        <option value="1" selected="selected">是</option>
                        <option value="2">否</option>
                        <?php  } else if($info['is_display']==2) { ?>
                        <option value="1">是</option>
                        <option value="2" selected="selected">否</option>
                        <?php  } else { ?>
                        <option value="1">是</option>
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">商家店铺幻灯片</label>
                    <div class="col-sm-9">
                       <?php  echo tpl_form_field_multi_image('img',$img3);?>

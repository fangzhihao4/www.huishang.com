...
<ul class="nav nav-tabs">    
    ...
    <li><a href="<?php  echo $this->createWebUrl('intxlist');?>">提现明细</a></li>
            ...
            <div class="panel-body">                
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      ...
                      <div class="apply_bei">*当前账户余额如果小于最低提现金额(<?php  echo $system['tx_money'];?>)，则不能提现</div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <?php  if($system['is_zfb']==1) { ?>
                        <label class="radio-inline">
                            <input type="radio" name="type" value="1" checked>支付宝
                        </label>
                    <?php  } ?>
                    ...
                    <?php  if($system['is_yhk']==1) { ?>
                        <label class="radio-inline">
                            <input type="radio" name="type" value="3">银行卡
                        </label>
                          <?php  } ?>
                    </div>

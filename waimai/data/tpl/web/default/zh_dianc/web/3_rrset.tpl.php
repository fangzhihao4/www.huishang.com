    ...
    <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data">
        ...
        <div class="panel panel-default ygdefault">
           ...
           <!--       <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">是否开启人人快递</label>
                    <div class="col-sm-9">
                        <label class="radio-inline">
                            <input type="radio" id="emailwy1" name="is_open" value="1" <?php  if($info['is_open']==1 ) { ?>checked<?php  } ?> />
                            <label for="emailwy1">开启</label>
                        </label>
                        <label class="radio-inline">
                            <input type="radio" id="emailwy2" name="is_open" value="2" <?php  if($info['is_open']==2|| empty($info['is_open'])) { ?>checked<?php  } ?> />
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="appkey" class="form-control" value="<?php  echo $info['appkey'];?>" />
                    </div>
                </div>

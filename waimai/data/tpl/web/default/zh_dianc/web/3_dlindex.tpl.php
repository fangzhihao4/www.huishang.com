            ...
            <div class="panel-body">  
                <div class="col-md-12 yg9_thing">
                    <ul class="col-md-4 list_one">
                        <li>
                            <div>待接单的外卖订单</div>
                            <div>(<a href="<?php  echo $this->createWebUrl2('dlinorder',array('type'=>now));?>"><span class="list_one_num"><?php  echo $sql6;?></span></a>)</div>
                        </li>
                        <li>
                            <div>待付款的店内订单</div>
                            <div>(<a href="<?php  echo $this->createWebUrl2('dlindnorder',array('type'=>wait));?>"><span class="list_one_num"><?php  echo $sql8;?><span class="list_one_num"></a>)</div>
                        </li>
                        <li>
                            <div>待审核的预定订单</div>
                            <div>(<a href="<?php  echo $this->createWebUrl2('dlinydorder',array('type'=>wait));?>"><span class="list_one_num"><?php  echo $sql9;?></span></a>)</div>
                        </li>
                    </ul>
                    <ul class="col-md-4 list_one">
                        <li>
                            <div>待送达的外卖订单</div>
                            <div>(<a href="<?php  echo $this->createWebUrl2('dlinorder',array('type'=>delivery));?>"><span class="list_one_num"><?php  echo $sql7;?></span></a>)</div>
                        </li>
                        <li>
                            <div>已开台的桌子</div>
                            <div>(<a href="<?php  echo $this->createWebUrl2('dltable2');?>"><span class="list_one_num"><?php  echo $sql11;?></span></a>)</div>
                        </li>
                       <!--  <li>
                            <div>待付款的订单</div>
                    ...
                    <ul class="col-md-4 list_one">
                        <li>
                            <div>完成的外卖订单</div>
                            <div>(<a href="<?php  echo $this->createWebUrl2('dlinorder',array('type'=>complete));?>"><span class="list_one_num"><?php  echo $sql10;?></span></a>)</div>
                        </li>
                        <li>
                            <div>未开台的桌子</div>
                            <div>(<a href="<?php  echo $this->createWebUrl2('dltable2');?>"><span class="list_one_num"><?php  echo $sql12;?></span></a>)</div>
                        </li>
                        <!-- <li>
                            <div>待付款的订单</div>
                            <div>(<span class="list_one_num">10</span>)</div>
...
<!--             <li class="col-md-1">
            ...
            <li class="">
              ...
              <a href="<?php  echo $this->createWebUrl2('dltable2');?>">
            <li class="">

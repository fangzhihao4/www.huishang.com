        ...
        <div class="panel panel-default ygdefault">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <label class="radio-inline">
                            <input type="radio" id="paywy1" name="is_yue" value="1" <?php  if($item['is_yue']==1 || empty($item['is_yue'])) { ?>checked<?php  } ?> />
                            <label for="paywy1">开启</label>
                        </label>
                        <label class="radio-inline">
                            <input type="radio" id="paywy2" name="is_yue" value="2" <?php  if($item['is_yue']==2) { ?>checked<?php  } ?> />
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <label class="radio-inline">
                            <input type="radio" id="yuewy" name="is_jfpay" value="1" <?php  if($item['is_jfpay']==1 || empty($item['is_jfpay'])) { ?>checked<?php  } ?> />
                            <label for="yuewy">开启</label>
                        </label>
                        <label class="radio-inline">
                            <input type="radio" id="yuewy2" name="is_jfpay" value="2" <?php  if($item['is_jfpay']==2) { ?>checked<?php  } ?> />

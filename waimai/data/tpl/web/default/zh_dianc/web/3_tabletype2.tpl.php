...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="<?php  echo $this->createWebUrl('tabletype2')?>">餐桌分类</a></li>
    <li><a href="<?php  echo $this->createWebUrl('addtabletype')?>">添加餐桌分类</a></li>
</ul>
<div class="main"> 
            ...
            <div class="row">              
              ...
              <tr class="yg5_tr2">
               ...
               <?php  echo $item['num'];?>
                ...
                <td>
                    <a href="<?php  echo $this->createWebUrl('addtabletype',array('id'=>$item['id']));?>" class="storespan btn btn-xs">
                        <span class="fa fa-pencil"></span>
                        <span class="bianji">编辑
                            <span class="arrowdown"></span>
                        </span>                                
                    </a>
                    <!-- <a class="btn btn-warning btn-sm" href="<?php  echo $this->createWebUrl('addtabletype',array('id'=>$item['id']));?>">编辑</a>                     -->
                </td>
                <td>
...
<div class="modal fade" id="myModal<?php  echo $item['id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                      <div class="modal-dialog" role="document">
                        ...
                        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                            <a href="<?php  echo $this->createWebUrl('tabletype2', array('id'=>$item['id']));?>" type="button" class="btn btn-info" >确定</a>
                        </div>
                    </div>
                </div>
            </div>

...
<div class="row">
    <div class="col-lg-12" style="margin-top: 15px;">
        ...
        <input type="hidden" name="c" value="site" />
                   ...
                   <input type="hidden" name="do" value="dmorder" />
            <div class="input-group" style="width: 300px">
                <input type="text" name="keywords" class="form-control" placeholder="请输入姓名/门店名称">
            ...
            <div class="panel-body" style="padding: 0px 15px;">
                <div class="row" style="position: relative;">
                    <div class="col-md-12 orderback">
                     ...
                     <a href="<?php  echo $this->createWebUrl('dmorder',array('op'=>'dy','order_id'=>$item['id']));?>"><button class="btn btn-xs orderbtn">打印小票</button></a>
                        </div>
                    ...
                    <div class="col-md-12 orderback3">
                        ...
                        <span class="ordertime">付款时间：<?php  echo $item['time'];?></span>
                        </div>
                    </div>
     ...
     <div class="col-md-4">
        <div class="panel panel-default">
            ...
            <div class="panel-body" style="padding: 15px;font-size: 16px;">                
                ...
                <!-- <p>营业额：<span class="dlorfont7"><?php  if($dm['total']) { ?><?php  echo $dm['total'];?><?php  } else { ?>0.00<?php  } ?></span>元</p> -->
                <p>营业额：</p>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" style="padding: 15px;font-size: 16px;">                
                ...
                <!-- <p>营业额：<span class="dlorfont7"><?php  if($ztdm['total']) { ?><?php  echo $ztdm['total'];?><?php  } else { ?>0.00<?php  } ?></span>元</p> -->
                <p>营业额：</p>

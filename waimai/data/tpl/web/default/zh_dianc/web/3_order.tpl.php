...
<ul class="nav nav-tabs">
    ...
    <li <?php  if($type=='cancel') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('order',array('type'=>cancel));?>">取消/退款</a></li> 
                ...
                <?php  if($item['order']['state']==1 || $item['order']['state']==5) { ?>
                    ...
                    <div class="col-md-12 orderback">
                        ...
                        <?php  } else if($item['order']['state']==7) { ?>
                            ...
                            <a href="<?php  echo $this->createWebUrl('order',array('op'=>'tg','id'=>$item['order']['id']));?>"><div class="left orderconfirm">通过退款</div></a>
                            <a href="<?php  echo $this->createWebUrl('order',array('op'=>'jj','id'=>$item['order']['id']));?>"><div class="left orderconfirm">拒绝退款</div></a>

        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body ygassess">
              ...
              <tr class="yg5_tr2">
                ...
                <td>
                <span class="label storered">未回复</span>
                </td>
                ...
                <td>
                  <?php  if($item['status']==1) { ?>
                  <a href="javascript:void(0);" data-toggle="modal" data-target="#myModal<?php  echo $item['id'];?>"><span class="btn btn-xs storeblue">回复</span> </a>
                  <?php  } else { ?>
                  <span class="btn btn-xs storegrey">已回复</span>
                  <?php  } ?>
                  ...
                  <!-- <a href="<?php  echo $this->createWebUrl2('dlassessinfo', array('id'=>$item['id'],'op'=>'info'));?>" class="btn btn-xs btn-info" >查看 </a>
                  <a onclick="if(!confirm('删除后将不可恢复,确定删除吗?')) return false;" href="<?php  echo $this->createWebUrl('assess', array('op'=>delete,'id'=>$item['id']));?>" class="btn btn-xs btn-danger" data-toggle="tooltip" data-placement="top" title="" data-original-title="删除"><i class="fa fa-times"></i> </a> -->   
                </td>
              </tr>

            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <?php  if($info['type']==1) { ?>
                            ...
                            <option value="3" >积分商城广告</option>
                        <?php  } else if($info['type']==2) { ?>
                            <option value="1" >首页幻灯片</option>
                            <option value="2" selected>开屏广告</option>
                            <option value="3" >积分商城广告</option>
                        <?php  } else if($info['type']==3) { ?>
                            <option value="1" >首页幻灯片</option>
                            <option value="2" >开屏广告</option>
                            <option value="3" selected>积分商城广告</option>
                        <?php  } else { ?>
                            <option value="1" >首页幻灯片</option>
                            <option value="2">开屏广告</option>
                            <option value="3" >积分商城广告</option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="ygmargin">*首页轮播图建议宽高750*360px　 开屏广告建议宽高360*750px</div>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group ygyi1">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="ygmargin">*跳转到商家链接(../info/info?id=1)id=商家id</div>
                        <div class="ygmargin">*跳分销中心../logs/distribution/yaoqing </div>
                        <div class="ygmargin">*跳我要入驻../logs/wyrz/authen</div>
                ...
                <div class="form-group ygyi2">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="src2" class="form-control" value="<?php  echo $info['src'];?>" />

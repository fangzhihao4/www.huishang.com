...
<ul class="nav nav-tabs">
    ...
    <li <?php  if($type=='zt') { ?> class="orderbtn2" <?php  } ?>><a href="<?php  echo $this->createWebUrl('inorder',array('type'=>zt));?>">自提订单</a></li>
    <li <?php  if($type=='cancel') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('inorder',array('type'=>cancel));?>">取消/退款</a></li> 
                ...
                <?php  if($item['order']['state']==1 || $item['order']['state']==5) { ?>
                    ...
                    <div class="col-md-12 orderback">
                        ...
                        <?php  } else if($item['order']['state']==7) { ?>
                            ...
                            <a href="<?php  echo $this->createWebUrl('inorder',array('op'=>'tg','id'=>$item['order']['id']));?>"><div class="left orderconfirm">通过退款</div></a>
                            <a href="<?php  echo $this->createWebUrl('inorder',array('op'=>'jj','id'=>$item['order']['id']));?>"><div class="left orderconfirm">拒绝退款</div></a>
...
$(function(){
    setInterval(function(){
               $.ajax({ 
                type: "post",
                dataType: "json",
                url: "<?php  echo $_W['siteroot'];?>/app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&do=jdorder&m=zh_dianc&id=<?php  echo $storeid;?>",
...
$(function(){
    ...
    setInterval(function(){
               $.ajax({ 
                type: "post",
                dataType: "json",
                url: "<?php  echo $_W['siteroot'];?>/app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&do=neworder&m=zh_dianc&store=<?php  echo $_COOKIE['storeid'];?>",
                success: function (data) {
                    console.log(data);
                    if(data==1){

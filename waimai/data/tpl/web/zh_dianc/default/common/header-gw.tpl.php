			...
			<div class="jumbotron clearfix alert alert-<?php  echo $label;?>">
				<div class="row">
					<div class="col-md-2 col-md-push-3">
						<!-- <i class="ygcheck fa fa-5x fa-<?php  if($label=='success') { ?>check-circle<?php  } ?><?php  if($label=='danger') { ?>times-circle<?php  } ?><?php  if($label=='info') { ?>info-circle<?php  } ?><?php  if($label=='warning') { ?>exclamation-triangle<?php  } ?>"></i> -->
						<img src="../addons/zh_dianc/template/images/duigoubai.png" class="ygcheck"/>
					</div>
					<div class="col-md-5 col-md-push-2">
						...
						<div class="xiaoren"><img src="../addons/zh_dianc/template/images/stick.gif"></div>

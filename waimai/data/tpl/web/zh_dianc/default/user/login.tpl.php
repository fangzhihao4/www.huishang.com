...
.sellback{
	...
	background:url(../addons/zh_dianc/template/images/container_bg0.png) no-repeat;
}
...
.warp_content .title span{
	background:url(../addons/zh_dianc/template/images/txt.png) 0 2px no-repeat;
	height:12px;
	display:block;
	margin-top:5px;
}
...
.formInfo .formText .login-icon{
	background: url(../addons/zh_dianc/template/images/login_icon.png) no-repeat;
	position: absolute;
	top: 13px;
	left: 17px;
	width: 14px;
...
.msection{
	...
	background-color: white;
	margin-top: 165px;
	background:url(../addons/zh_dianc/template/images/u11_state0.png) no-repeat;
...
<!-- <div class="msection">
	<div class="msecbox">
		<div class="msecheader">
			<img src="../addons/zh_dianc/template/images/u270.png">
		</div>
		<form action="" method="post" role="form" id="form1" onsubmit="return formcheck();">
			<div class="mscontent">
				<p class="mstitle">商家后台业务管理系统</p>

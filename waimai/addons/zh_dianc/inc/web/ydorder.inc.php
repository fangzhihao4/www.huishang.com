...
$wx = "select sum(pay_money) as total from " . tablename("wpdc_ydorder")." WHERE created_time LIKE ".$time."  and state  in (7,2) and is_yue=2";
$wx = pdo_fetch($wx);//今天的微信外卖销售额
$yue = "select sum(pay_money) as total from " . tablename("wpdc_ydorder")." WHERE created_time LIKE ".$time."  and state  in (7,2) and is_yue=1";
$yue = pdo_fetch($yue);//今天的余额外卖销售额
$jf = "select sum(pay_money) as total from " . tablename("wpdc_ydorder")." WHERE created_time LIKE ".$time."  and state  in (7,2) and is_yue=3";
$jf = pdo_fetch($jf);//今天的积分外卖销售额

$ztwx = "select sum(pay_money) as total from " . tablename("wpdc_ydorder")." WHERE created_time LIKE ".$time2."  and state  in (7,2) and is_yue=2";
$ztwx = pdo_fetch($ztwx);//昨天的微信外卖销售额
$ztyue = "select sum(pay_money) as total from " . tablename("wpdc_ydorder")." WHERE created_time LIKE ".$time2."  and state  in (7,2) and is_yue=1";
$ztyue = pdo_fetch($ztyue);//昨天的余额外卖销售额
$ztjf = "select sum(pay_money) as total from " . tablename("wpdc_ydorder")." WHERE created_time LIKE ".$time2."  and state  in (7,2) and is_yue=3";
...
$yd2 = "select * from " . tablename("wpdc_ydorder")." WHERE created_time LIKE ".$time." and state  in (7,2) and uniacid=".$_W['uniacid'];
$yd2 = count(pdo_fetchall($yd2));//今天外卖订单量
$wxyd2 = "select * from " . tablename("wpdc_ydorder")." WHERE created_time LIKE ".$time." and state  in (7,2) and is_yue=2 and uniacid=".$_W['uniacid'];
$wxyd2 = count(pdo_fetchall($wxyd2));//今天外卖微信订单量
$yueyd2 = "select * from " . tablename("wpdc_ydorder")." WHERE created_time LIKE ".$time." and state  in (7,2) and is_yue=1 and uniacid=".$_W['uniacid'];
$yueyd2 = count(pdo_fetchall($yueyd2));//今天外卖余额订单量
$jfyd2 = "select * from " . tablename("wpdc_ydorder")." WHERE created_time LIKE ".$time." and state  in (7,2) and is_yue=3 and uniacid=".$_W['uniacid'];
$jfyd2 = count(pdo_fetchall($jfyd2));//今天外卖积分订单量




$ztyd2 = "select * from " . tablename("wpdc_ydorder")." WHERE created_time LIKE ".$time2." and state  in (7,2) and uniacid=".$_W['uniacid'];
$ztyd2 = count(pdo_fetchall($ztyd2));//昨天外卖订单量
$ztwxyd2 = "select * from " . tablename("wpdc_ydorder")." WHERE created_time LIKE ".$time2." and state  in (7,2) and is_yue=2 and uniacid=".$_W['uniacid'];
$ztwxyd2 = count(pdo_fetchall($ztwxyd2));//昨天外卖微信订单量
$ztyueyd2 = "select * from " . tablename("wpdc_ydorder")." WHERE created_time LIKE ".$time2." and state  in (7,2) and is_yue=1 and uniacid=".$_W['uniacid'];
$ztyueyd2 = count(pdo_fetchall($ztyueyd2));//昨天外卖余额订单量
$ztjfyd2 = "select * from " . tablename("wpdc_ydorder")." WHERE created_time LIKE ".$time2." and state  in (7,2) and is_yue=3 and uniacid=".$_W['uniacid'];
$ztjfyd2 = count(pdo_fetchall($ztjfyd2));//昨天外卖积分订单量
...
// $yd = "select sum(pay_money) as total from " . tablename("wpdc_ydorder")." WHERE created_time LIKE ".$time."  and state not in (0,4,6) ";
// $yd = pdo_fetch($yd);//今天的外卖销售额
// $ztyd = "select sum(pay_money) as total from " . tablename("wpdc_ydorder")." WHERE created_time LIKE ".$time2."  and state not in (0,4,6) ";
// $ztyd = pdo_fetch($ztyd);//昨天的外卖销售额

// $yd2 = "select * from " . tablename("wpdc_ydorder")." WHERE created_time LIKE ".$time."  and state!=0 and uniacid=".$_W['uniacid'];
// $yd2 = count(pdo_fetchall($yd2));

// $ztyd2 = "select * from " . tablename("wpdc_ydorder")." WHERE created_time LIKE ".$time2." and state!=0 and uniacid=".$_W['uniacid'];
// $ztyd2 = count(pdo_fetchall($ztyd2));

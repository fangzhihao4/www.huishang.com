...
$GLOBALS['frames'] = $this->getMainMenu();
	$info = pdo_get('wpdc_jfgoods',array('uniacid' => $_W['uniacid'],'id'=>$_GPC['id']));
	$type = pdo_getall('wpdc_jftype',array('uniacid' => $_W['uniacid']));
		if(checksubmit('submit')){
			...
			if($_GPC['id']==''){				
				$res=pdo_insert('wpdc_jfgoods',$data);
				if($res){
				...
				$res = pdo_update('wpdc_jfgoods', $data, array('id' => $_GPC['id']));
				if($res){

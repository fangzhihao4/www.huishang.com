        ...
        a.setData({
            ...
            success: function(t) {
                if (wx.hideLoading(), 1 == t.code && wx.showModal({
                    ...
                    for (var o in console.log(t.data.goods_list), t.data.goods_list) t.data.goods_list[o].score = 3, 
                    t.data.goods_list[o].content = "", t.data.goods_list[o].pic_list = [], t.data.goods_list[o].uploaded_pic_list = [];
                    a.setData({
